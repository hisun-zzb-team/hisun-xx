...
<body>
					...
					<div class="clearfix">
						<div class="control-group">
							<div id="query" style="float: left;">
								<form action="${path }/xx/app/console/appClient/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" method="POST" id="searchForm" name="searchForm">
	...
	<script type="text/javascript">
		...
		var del = function(id,itemName){
			actionByConfirm1(itemName, "${path}/xx/app/console/appClient/delete/" + id+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}",{} ,function(data,status){
		...
		function changeStatus(id){
			$.cloudAjax({
				path : '${path}',
				url : "${path }/xx/app/console/appClient/changeStatus/"+id,
				type : "post",
