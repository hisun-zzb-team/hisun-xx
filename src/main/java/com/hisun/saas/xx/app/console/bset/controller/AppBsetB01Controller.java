...
import com.hisun.saas.xx.app.console.aset.service.AppAsetA36Service;
...
import com.hisun.saas.xx.app.console.bset.service.AppBsetFl2B01Service;
import com.hisun.saas.xx.app.console.bset.service.AppBsetFlService;
import com.hisun.saas.xx.app.console.bset.vo.AppBsetB01Vo;
import com.hisun.saas.xx.app.console.bset.vo.B01TreeVo;
import com.hisun.saas.xx.app.console.bset.vo.ImportParameterVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/bset")
public class AppBsetB01Controller extends BaseController{
    ...
    public ModelAndView list(){
        ...
        return new ModelAndView("saas/xx/app/console/bsetB01/b01Manage");
...
//            map.put("zsId", zsId);
        ...
        return new ModelAndView("saas/xx/app/console/bsetB01/rightList", map);
    ...
    public ModelAndView addOrEditManage(@RequestParam(value="dataType",required=false)String dataType,@RequestParam(value="parentId",required=false)String parentId,@RequestParam(value="id",required=false)String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/bsetB01/addAndEditB01Manage",map);
    }
...
//                vo.setParentId(parentId);
        ...
        return new ModelAndView("/saas/xx/app/console/bsetB01/addAndEditB01",map);
    }
    ...
    public ModelAndView importParamSet(@RequestParam(value="importType",required=false)String importType) {
        ...
        return new ModelAndView("/saas/xx/app/console/bsetB01/importParameter",map);
    }
    /**
     * 保存部务会信息
     * @return
