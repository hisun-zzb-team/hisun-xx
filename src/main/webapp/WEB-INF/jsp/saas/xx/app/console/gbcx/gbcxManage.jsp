...
//				beforeDrop: beforeDrop,
		...
		$.ajax({
			async:false,
			type:"POST",
			url:"${path}/xx/app/console/appGbcxB01/ajax/load/tree",
			dataType : "json",
			headers:{
...
//		}
	...
	var deleteTreeNode = function(){
		...
		actionByConfirm1(itemName, "${path}/xx/app/console/appGbcxB01/delete/" + id,{} ,function(data,status){
			if (data.success == true) {
				showTip("提示","删除成功", 2000);
				setTimeout(function(){window.location.href = "${path}/xx/app/console/gbcx/"},2000);
			}else{
