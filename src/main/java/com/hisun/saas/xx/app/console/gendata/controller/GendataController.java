...
package com.hisun.saas.xx.app.console.gendata.controller;
...
import com.hisun.saas.xx.app.console.gbmc.vo.GbMcVo;
import com.hisun.saas.xx.app.console.gbtj.entity.Gbtj;
import com.hisun.saas.xx.app.console.gbtj.service.GbtjService;
import com.hisun.saas.xx.app.console.gbtj.vo.GbtjVo;
import com.hisun.saas.xx.app.console.gendata.entity.DataPacketContent;
import com.hisun.saas.xx.app.console.gendata.entity.Gendata;
import com.hisun.saas.xx.app.console.gendata.service.DataPacketContentService;
import com.hisun.saas.xx.app.console.gendata.service.GendataService;
import com.hisun.saas.xx.app.console.gendata.vo.GendataVo;
import com.hisun.saas.xx.app.console.shpc.entity.Sha01;
import com.hisun.saas.xx.app.console.shpc.entity.Sha01gbrmspb;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gendata")
public class GendataController extends BaseController{
    ...
    public ModelAndView list(HttpServletRequest req, String pId,
        ...
        return new ModelAndView("saas/xx/app/console/gendata/list", map);
    }
    ...
    public ModelAndView loadGenerator(){
        ...
        return new ModelAndView("saas/xx/app/console/gendata/generator",map);
    }
    ...
    public ModelAndView loadGeneratorByoldPacket(@RequestParam(value = "oldPacketId") String oldPacketId){
        ...
        return new ModelAndView("saas/xx/app/console/gendata/generatorByoldPacket",map);
    }
