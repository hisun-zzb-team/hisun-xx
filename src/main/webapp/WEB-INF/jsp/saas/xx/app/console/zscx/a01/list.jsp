...
//				$("#treeId").val(nodeId);
	...
	var view = function(id){
		$.ajax({
			async:false,
			type:"POST",
			url:"${path}/xx/app/console/asetA01/ajax/viewByZscx",
			dataType : "html",
			headers:{
				"OWASP_CSRFTOKEN":'${sessionScope.OWASP_CSRFTOKEN}'
			},
	...
	var del = function(id,itemName){
		actionByConfirm1(itemName, "${path}/xx/app/console/asetA01/delete/" + id+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}",{} ,function(data,status){
			if (data.success == true) {
				...
				setTimeout(function(){window.location.href = "${path}/xx/app/console/asetA01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&b01Id=${b01Id}&mcid=${mcid}"},2000);
			}else{
