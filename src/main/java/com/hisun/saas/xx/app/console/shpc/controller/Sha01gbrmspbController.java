...
import com.hisun.saas.xx.app.console.shpc.service.Sha01gbrmspbService;
import com.hisun.saas.xx.app.console.shpc.service.Sha01kcclService;
 ...
 */
@Controller
@RequestMapping("/xx/app/Sha01/gbrmspb")
...
//                this.sha01gbrmspbService.saveFromWord(sha01gbrmspb ,savePath,wordTemplatePath);
    ...
    ModelAndView batchMatch(String shpcId, String
        ...
        map.put("code", 1);
        return new ModelAndView("/saas/xx/app/console/Sha01/matchResult", map);
    }
    ...
    public void templateDown(String sha01Id, HttpServletRequest req, HttpServletResponse resp) throws Exception {
            ...
            resp.setHeader("Content-Disposition", "attachment;fileName=" + encode("国家动物疫病防治对策研究.doc"));
            OutputStream output = resp.getOutputStream();
            byte[] b = FileUtils.readFileToByteArray(new File(uploadAbsolutePath + File.separator + "xx"+File.separator+"biyelunwendq0377392.doc"));
            output.write(b);
            output.flush();
            output.close();
    }
