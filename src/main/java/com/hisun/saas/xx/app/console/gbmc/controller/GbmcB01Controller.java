...
import com.hisun.saas.xx.app.console.gbmc.vo.GbMcB01Vo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gbmc/b01")
public class GbmcB01Controller extends BaseController{
    ...
    public ModelAndView list(HttpServletRequest req, @RequestParam(value="mcid")String mcid,String b0101Query,
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/b01/list", map);
    }
    ...
    public ModelAndView add(@RequestParam(value="mcid")String mcid) {
        ...
        gbMcVo.setId(mcid);
        vo.setGbMcVo(gbMcVo);
        return new ModelAndView("/saas/xx/app/console/gbmc/b01/add","gbMcB01",vo);
    ...
    public ModelAndView edit(@RequestParam(value="id")String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/b01/edit", map);
    }
