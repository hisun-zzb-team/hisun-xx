 ...
 */
@Controller
@RequestMapping("/xx/app/console/zscx")
public class ZscxController extends BaseController {
    ...
    public ModelAndView zscxManage(){
        ...
        return new ModelAndView("saas/xx/app/console/zscxTmp/zscxManage");
    }
    ...
    public ModelAndView getList(String b01Id,String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/zscxTmp/list", map);
