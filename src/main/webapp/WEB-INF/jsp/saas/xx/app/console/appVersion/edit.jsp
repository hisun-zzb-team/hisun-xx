					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="${path }/xx/app/console/appVersion/save?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" class="form-horizontal" id="form1" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										<div class="controls mt10">
											...
											<a class="btn" href="${path }/xx/app/console/appVersion/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"><i class="icon-remove-sign"></i> 取消</a>
										</div>
									</div>
								</form>
							</div>
...
<script type="text/javascript">
	...
	<%--function formUpdate(){--%>
		...
		<%--if(bool){--%>
			<%--$.cloudAjax({--%>
				<%--path : '${path}',--%>
				<%--url : "${path }/xx/app/console/appVersion/save",--%>
				<%--type : "post",--%>
				...
				<%--success : function(data){--%>
					<%--if(data.success){--%>
						...
						<%--setTimeout(function(){window.location.href = "${path}/xx/app/console/appVersion/"},2000);--%>
					<%--}else{--%>
	...
	function formSubmit(){
		...
		$("#form1").ajaxSubmit({
			...
			success : function(data){
				...
				if(data.success){
					showTip("提示","操作成功",2000);
					setTimeout(function(){window.location.href = "${path}/xx/app/console/appVersion/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"},2000);
				}else{
					showTip("提示", json.message, 2000);
				}
			},
	...
	function fileDown() {
		window.open("${path }/xx/app/console/appVersion/ajax/down?id=${appVersionVo.id}&OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}");
	}
