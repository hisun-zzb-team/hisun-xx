				...
				<div class="clearfix">
					<div class="control-group">
						<div id="query" style="float: left;">
							<form action="${path }/xx/app/console/tp/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" method="POST" id="searchForm" name="searchForm">
								...
								<c:forEach items="${pager.datas}" var="vo">
									<tr style="text-overflow:ellipsis;">
										...
										<td class="Left_alignment">
											<a href="${path}/xx/app/console/tp/result?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&shpcId=${vo.id }" class="">查看</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
