 ...
 */
@Controller
@RequestMapping("/xx/app/console/bset/fl")
public class AppBsetB01flController extends BaseController{

    @RequestMapping(value = "/flManage")
    public ModelAndView list(){
        return new ModelAndView("saas/xx/app/console/bsetB01/fl/flManage");
    }
    ...
    public ModelAndView getList(String queryId,String b0101Query,
        ...
        return new ModelAndView("saas/xx/app/console/bsetB01/fl/rightList", map);
