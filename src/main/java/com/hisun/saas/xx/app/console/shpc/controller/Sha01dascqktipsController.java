...
import com.hisun.saas.xx.app.console.shpc.entity.Sha01dascqktips;
import com.hisun.saas.xx.app.console.shpc.service.Sha01Service;
import com.hisun.saas.xx.app.console.shpc.service.Sha01dascqktipsService;
 ...
 */
@Controller
@RequestMapping("/xx/app/Sha01/dascqk/dascqktips")
public class Sha01dascqktipsController extends BaseController {
    ...
    public ModelAndView add() {
        return new ModelAndView("/saas/xx/app/console/Sha01/dascqktips/addAndEdit");
    }
    /**
     * 调转到修改页面
     * @return
    ...
    public ModelAndView edit(@RequestParam(value="sha01Id")String sha01Id) {
        ...
        return new ModelAndView("/saas/xx/app/console/Sha01/dascqktips/addAndEdit", map);
    }
