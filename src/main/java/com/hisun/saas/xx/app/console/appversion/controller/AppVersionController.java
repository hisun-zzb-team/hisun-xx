...
package com.hisun.saas.xx.app.console.appversion.controller;
...
import com.hisun.saas.xx.app.console.appversion.vo.AppVersionVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/appVersion")
public class AppVersionController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest req,
        ...
        return new ModelAndView("/saas/xx/app/console/appVersion/list", map);
    }
    ...
    public ModelAndView add() {
        AppVersionVo vo = new AppVersionVo();
        return new ModelAndView("/saas/xx/app/console/appVersion/add","appVersion",vo);
    ...
    public ModelAndView edit(@RequestParam(value="id")String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/appVersion/edit", map);
    }
