...
import com.hisun.saas.xx.app.console.gbmc.vo.GbMcA01Vo;
import com.hisun.saas.xx.app.console.gbmc.vo.GbMcA01Vo;
import com.hisun.saas.xx.app.console.gbmc.vo.GbMcA01gzjlVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gbmc/a01")
...
//                query.add(CommonRestrictions.and(" xm like :xmQuery", "xmQuery", "%"+ xmQuery+ "%"));
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/a01/list", map);
    }
...
//    @RequiresPermissions("admin-assetStatus:edit")
    ...
    public ModelAndView view(@RequestParam(value="id")String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/a01/view", map);
    }
}
