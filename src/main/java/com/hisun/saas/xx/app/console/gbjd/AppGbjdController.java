...
package com.hisun.saas.xx.app.console.gbjd;
...
import com.hisun.saas.xx.app.console.aset.service.AppAsetA01Service;
import com.hisun.saas.xx.app.console.aset.vo.AppAsetA01Vo;
import com.hisun.saas.xx.app.console.bset.entity.AppBsetB01;
import com.hisun.saas.xx.app.console.bset.entity.AppBsetFl;
import com.hisun.saas.xx.app.console.bset.service.AppBsetB01Service;
import com.hisun.saas.xx.app.console.bset.service.AppBsetFlService;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gbjd")
public class AppGbjdController extends BaseController{
    ...
    public ModelAndView dashboard(){
        return new ModelAndView("saas/xx/app/console/gbjd/dashboard");
    }

    @RequestMapping(value = "/base")
    public ModelAndView base(){
        return new ModelAndView("saas/xx/app/console/gbjd/base/a01/a01QueryManage");
    }
    ...
    public ModelAndView getList(String b01Id, String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/gbjd/base/a01/list", map);
    ...
    public ModelAndView addManage(String b01Id) throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/gbjd/base/addManage", map);
    }
    ...
    public ModelAndView view(@RequestParam(value = "id") String id, @RequestParam(value = "b01Id") String b01Id) {
        ...
        return new ModelAndView("/saas/xx/app/console/gbjd/base/a01/view", map);
    }
    @RequestMapping(value = "/view2")
    public ModelAndView view2(String b01Id) throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/gbjd/base/view2", map);
    }
    @RequestMapping(value = "/view3")
    public ModelAndView view3(String b01Id) throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/gbjd/base/view3", map);
    }
    @RequestMapping(value = "/ajax/editBase")
    public ModelAndView editBase(){
        return new ModelAndView("saas/xx/app/console/gbjd/base/addBase");
    }
    ...
    public ModelAndView grsxchGrList(){
        ...
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/base/sjccgbGrList",map);
    }
    ...
    public ModelAndView sjgbGrList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/base/sjgbGrList",map);
    }
    ...
    public ModelAndView xfjbGrList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/base/xfjbGrList",map);
    }
    ...
    public ModelAndView ssyjList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/ssyj/list",map);
    }
    ...
    public ModelAndView zrzjGrList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/base/zrzjGrList",map);
    }
    ...
    public ModelAndView wzGrList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/base/wzGrList",map);
    }
    //=========================
    ...
    public ModelAndView sjcc(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/sjcc/list", map);
    }
    ...
    public ModelAndView sjccgbList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/sjcc/ccgbList",map);
    }
    @RequestMapping(value = "/grsxch/sjccgbAdd")
    public ModelAndView sjccgbAdd(){
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/sjcc/sjccgbAdd");
    }
    ...
    public ModelAndView zdch(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/zdch/list",map);
    }
    ...
    public ModelAndView zdchgbList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/sjcc/zdchgbList",map);
    }
    @RequestMapping(value = "/grsxch/zdchgbAdd")
    public ModelAndView zdchgbAdd(){
        return new ModelAndView("saas/xx/app/console/gbjd/grsxch/sjcc/zdchgbAdd");
    }
    ...
    public ModelAndView jjzrsj(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/jjzrsj/list",map);
    }
    ...
    public ModelAndView sjgbList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/jjzrsj/sjgbList",map);
    }

    @RequestMapping(value = "/jjzrsj/edit")
    public ModelAndView jjzrsjEdit(){
        return new ModelAndView("saas/xx/app/console/gbjd/jjzrsj/edit");
    }
    ...
    public ModelAndView xfjb(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/xfjb/list",map);
    }

    @RequestMapping(value = "/xfjb/edit")
    public ModelAndView xfjbEdit(){
        return new ModelAndView("saas/xx/app/console/gbjd/xfjb/edit");
    }
    ...
    public ModelAndView ybglpy(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/ybglpy/list",map);
    }
    ...
    public ModelAndView pyjgList(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/ybglpy/pyjgList",map);
    }
    ...
    public ModelAndView ybglpyEdit(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/ybglpy/edit",map);
    }
    ...
    public ModelAndView zrzj(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/zrzj/list",map);
    }
    @RequestMapping(value = "/zrzj/edit")
    public ModelAndView zrzjEdit(){
        return new ModelAndView("saas/xx/app/console/gbjd/zrzj/edit");
    }
    ...
    public ModelAndView dzzwz(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/wz/dzzwz/list",map);
    }
    ...
    public ModelAndView wz(){
        ...
        PagerVo<AppAsetA01Vo> pagerVo = new PagerVo<AppAsetA01Vo>(null, 10, 1, 10);
        map.put("pager", pagerVo);
        return new ModelAndView("saas/xx/app/console/gbjd/wz/ldgbwz/list",map);
    }
    @RequestMapping(value = "/wz/dzzwz/edit")
    public ModelAndView dzzwzEdit(){
        return new ModelAndView("saas/xx/app/console/gbjd/wz/dzzwz/edit");
    }
    @RequestMapping(value = "/wz/ldgbwz/edit")
    public ModelAndView ldgbwzEdit(){
        return new ModelAndView("saas/xx/app/console/gbjd/wz/ldgbwz/edit");
    }
    @RequestMapping(value = "/ajax/viewGbjd")
    public ModelAndView viewGbjd(){
        return new ModelAndView("saas/xx/app/console/gbjd/viewGbjd");
    }
}
