...
import com.hisun.saas.xx.app.console.aset.entity.AppAsetA01Query;
import com.hisun.saas.xx.app.console.aset.service.AppAsetA01QueryService;
...
import com.hisun.saas.xx.app.console.aset.vo.AppAsetA01QueryVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/asetA01Query")
public class AppAsetA01QueryController extends BaseController {
    ...
    public ModelAndView getList(String queryId, String xmQuery,String queryPosition,
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/query/list", map);
    ...
    public ModelAndView queryList(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum,
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/query/queryList", map);
    ...
    public ModelAndView add(String addType) throws Exception {
        ...
        return new ModelAndView("/saas/xx/app/console/asetA01/query/addOrEdit", map);
    }
...
//    @RequiresPermissions("admin-assetStatus:edit")
    ...
    public ModelAndView edit(@RequestParam(value = "id") String id) {
        ...
        try {
         ...
         return new ModelAndView("/saas/xx/app/console/asetA01/query/addOrEdit", "vo", vo);
    }
...
//    @RequiresPermissions("admin-assetStatus:delete")
    ...
    public ModelAndView view(@RequestParam(value = "id") String id, String queryId,String queryPosition) {
        ...
        return new ModelAndView("/saas/xx/app/console/asetA01/query/view", map);
    }
...
//        }
    ...
    public ModelAndView gjcx() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/query/gjcxManage", map);
    }
}
