...
package com.hisun.saas.xx.app.console.gbtj.controller;
...
import com.hisun.saas.xx.app.console.gbtj.vo.Sha01JsonDataVo;
import com.hisun.saas.xx.app.console.gbtj.vo.Sha01JsonSavaVo;
import com.hisun.saas.xx.app.console.gbtj.vo.Sha01JsonVo;
import com.hisun.saas.xx.app.console.shpc.vo.Sha01dascqktipsVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gbtj")
public class GbtjController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest req, String pId,
        ...
        return new ModelAndView("/saas/xx/app/console/gbtj/list", map);
    }
    ...
    public ModelAndView add() {
        GbtjVo vo = new GbtjVo();
        vo.setPx(99);
        return new ModelAndView("/saas/xx/app/console/gbtj/add","gbtj",vo);
    ...
    public ModelAndView edit(@RequestParam(value="id")String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/gbtj/edit", map);
    }
...
//    @RequiresPermissions("admin-assetStatus:delete")
    ...
    public ModelAndView editJsonData(@RequestParam(value="id")String id) {
        ...
        map.put("id",id);
        return new ModelAndView("/saas/xx/app/console/gbtj/addAndEditJsonData", map);
    }
    ...
    public ModelAndView btView(@RequestParam(value="id")String id) {
        ...
        ModelAndView modelAndView = new ModelAndView(
                "/saas/xx/app/console/gbtj/btView", model);
        return modelAndView;
    }
}
