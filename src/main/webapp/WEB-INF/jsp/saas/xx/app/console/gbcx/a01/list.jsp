			...
			<div class="clearfix">
				<div class="control-group">
					<div id="query" style="float: left;">
						<form action="${path }/xx/app/console/appGbcxA01/ajax/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" method="POST" id="searchForm" name="searchForm">
...
<script type="text/javascript">
	...
	function pagehref (pageNum ,pageSize){
		...
		$.ajax({
			async:false,
			type:"POST",
			url:"${path}/xx/app/console/appGbcxA01/ajax/list",
			dataType : "html",
			headers:{
				"OWASP_CSRFTOKEN":'${sessionScope.OWASP_CSRFTOKEN}'
			},
...
//				$("#treeId").val(nodeId);
	...
	var del = function(id,itemName){
		actionByConfirm1(itemName, "${path}/xx/app/console/appGbcxA01/delete/" + id+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}",{} ,function(data,status){
			if (data.success == true) {
				showTip("提示","删除成功", 2000);
				setTimeout(function(){window.location.href = "${path}/xx/app/console/appGbcxA01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&b01Id=${b01Id}&mcid=${mcid}"},2000);
			}else{
