...
package com.hisun.saas.xx.app.console.shtp.controller;
...
import com.hisun.saas.xx.app.console.shtp.vo.ShtpVo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/tp")
public class ShtpController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest req, String pcmc,String pch,
        ...
        return new ModelAndView("/saas/xx/app/console/tp/list", map);
    }
    ...
    public ModelAndView tplist(HttpServletRequest req,@RequestParam(value="shpcId")String shpcId,
        ...
        return new ModelAndView("/saas/xx/app/console/tp/tpList", map);
    }
...
//                    pageNum, pageSize);
        ...
        return new ModelAndView("/saas/xx/app/console/tp/result", map);
    }
