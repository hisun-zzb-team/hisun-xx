							...
							<div class="portlet-body form">
								...
								<form action="" class="form-horizontal" id="form1" method="post">
									...
									<div class="form-actions">
										...
										<a class="btn" href="${path }/xx/app/console/gbmc/b01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}"><i class="icon-remove-sign"></i> 取消</a>
			...
			$.cloudAjax({
				...
				success : function(data){
					if(data.success){
						...
						setTimeout(function(){window.location.href = "${path}/xx/app/console/gbmc/b01/list?mcid=${mcid}&OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"},2000);
					}else{
