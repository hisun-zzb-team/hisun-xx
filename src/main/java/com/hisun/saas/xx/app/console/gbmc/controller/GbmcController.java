...
package com.hisun.saas.xx.app.console.gbmc.controller;
...
import com.hisun.saas.xx.app.console.gbmc.entity.*;
import com.hisun.saas.xx.app.console.gbmc.service.GbMcA01Service;
import com.hisun.saas.xx.app.console.gbmc.service.GbMcA01gbrmspbService;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/gbmc")
...
//                    }
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/list", map);
    }
    //=============================演示使用
    @RequestMapping("/ys")
...
//                    }
    ...
    public ModelAndView add() {
        GbMcVo vo = new GbMcVo();
        vo.setPx(99);
        return new ModelAndView("/saas/xx/app/console/gbmc/add","gbMc",vo);
    ...
    public ModelAndView edit(@RequestParam(value="id")String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/gbmc/edit", map);
    }
