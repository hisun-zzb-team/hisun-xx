...
//				$("#treeId").val(nodeId);
	...
	var del = function(id,itemName){
		actionByConfirm1(itemName, "${path}/xx/app/console/appZscxZs/delete/" + id,{} ,function(data,status){
			if (data.success == true) {
				showTip("提示","删除成功", 2000);
				setTimeout(function(){window.location.href = "${path}/xx/app/console/appZscxZs/list?b01Id=${b01Id}&mcid=${mcid}"},2000);
			}else{
