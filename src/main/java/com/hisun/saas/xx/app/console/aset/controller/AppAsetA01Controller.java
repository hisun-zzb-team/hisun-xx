...
package com.hisun.saas.xx.app.console.aset.controller;
...
import com.hisun.saas.xx.app.console.aset.service.AppAsetA02Service;
import com.hisun.saas.xx.app.console.aset.vo.AppAsetA02Vo;
 ...
 */
@Controller
@RequestMapping("/xx/app/console/asetA01")
public class AppAsetA01Controller extends BaseController {
    ...
    public ModelAndView list() {
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/a01QueryManage");
...
//=====================================================干部管理演示使用
    ...
    public ModelAndView manage() {
        return new ModelAndView("saas/xx/app/console/asetA01/a01Manage");
    }
    ...
    public ModelAndView getManageList(String b01Id, String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/manage/list", map);
    ...
    public ModelAndView getManageList2(String b01Id, String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/manage/list2", map);

    }
    @RequestMapping(value = "/addManage")
    public ModelAndView addManage(String b01Id) throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/addManage", map);
    }
    ...
    public ModelAndView addBase() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/addBase", map);
    }
    @RequestMapping(value = "/ajax/addXrzwList")
    public ModelAndView addXrzwList() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/xrzw/list", map);
    }

    @RequestMapping(value = "/ajax/addXrzw")
    public ModelAndView addXrzw() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/xrzw/addXrzw", map);
    }
    @RequestMapping(value = "/ajax/addGzjl")
    public ModelAndView addGzjl() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/gzjl/list", map);
    }
    @RequestMapping(value = "/ajax/drGbList")
    public ModelAndView drGbList() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/drgb/list", map);
    }
    @RequestMapping(value = "/ajax/importGb")
    public ModelAndView importGb() throws Exception {
        Map<String, Object> map = Maps.newHashMap();
        return new ModelAndView("/saas/xx/app/console/asetA01/manage/drgb/importGb", map);
    }

    @RequestMapping(value = "/xlxw")
    public ModelAndView xlxwList() {
        return new ModelAndView("saas/xx/app/console/asetA01/manage/xlxw/list");
    }
    @RequestMapping(value = "/rysgpx")
    public ModelAndView rysgpxList() {
        return new ModelAndView("saas/xx/app/console/asetA01/manage/rysgpx/list");
    }
    @RequestMapping(value = "/xxqx")
    public ModelAndView xxqxList() {
        return new ModelAndView("saas/xx/app/console/asetA01/manage/xxqx/list");
    }
    @RequestMapping(value = "/gbxxsh")
    public ModelAndView gbxxshList() {
        return new ModelAndView("saas/xx/app/console/asetA01/manage/gbxxsh/list");
    }
    ...
    public ModelAndView getList(String b01Id, String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/asetA01/a01/list", map);
    ...
    public ModelAndView getListByZscx(String b01Id,String zsId, String xmQuery,
        ...
        return new ModelAndView("saas/xx/app/console/zscx/a01/list", map);
...
//        }
        ...
        return new ModelAndView("/saas/xx/app/console/asetA01/a01/add", "vo", vo);
    }
...
//    @RequiresPermissions("admin-assetStatus:edit")
    ...
    public ModelAndView edit(@RequestParam(value = "id") String id) {
        ...
        return new ModelAndView("/saas/xx/app/console/asetA01/a01/edit", map);
    }
...
//    @RequiresPermissions("admin-assetStatus:delete")
    ...
    public ModelAndView view(@RequestParam(value = "id") String id, @RequestParam(value = "b01Id") String b01Id) {
        ...
        return new ModelAndView("/saas/xx/app/console/asetA01/a01/view", map);
    }
    ...
    public ModelAndView viewByZscx(@RequestParam(value = "id") String id, @RequestParam(value = "b01Id") String b01Id,@RequestParam(value = "zsId") String zsId) {
        ...
        return new ModelAndView("/saas/xx/app/console/zscx/a01/view", map);
    }
    /**
     * 保存信息
     *
