		...
		<div class="span12 responsive">
			...
			<form class=""id="importForm" enctype="multipart/form-data">
				...
				<div class="portlet-title">
					<div class="caption">学历学位审核列表</div>
			...
			<div class="clearfix">
				<div class="control-group">
					<div id="query" style="float: left;">
						<form action="${path }/xx/app/console/asetA01/ajax/list" method="POST" id="searchForm" name="searchForm">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover dataTable table-set">
						...
						<tr>
							...
							<th width="40">性别</th>
							<th>现任职务</th>
							<th width="100" style="text-align: center">未审核学历
							</th>
							<th width="150" style="text-align: center">未审核学历
...
//				$("#treeId").val(nodeId);
	...
	var del = function(id,itemName){
		actionByConfirm1(itemName, "${path}/xx/app/console/asetA01/delete/" + id,{} ,function(data,status){
			if (data.success == true) {
				showTip("提示","删除成功", 2000);
				setTimeout(function(){window.location.href = "${path}/xx/app/console/asetA01/list?b01Id=${b01Id}&mcid=${mcid}"},2000);
			}else{
