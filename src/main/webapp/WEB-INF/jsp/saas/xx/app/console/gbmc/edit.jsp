...
<body>
							...
							<div class="portlet-body form">
								...
								<form action="" class="form-horizontal" id="form1" method="post"enctype="multipart/form-data">
									...
									<div class="form-actions">
										...
										<a class="btn" href="${path }/xx/app/console/gbmc/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"><i class="icon-remove-sign"></i> 取消</a>
			...
			<script type="text/javascript">
				...
				function formUpdate() {
					...
					myLoading.show();
					$("#form1").ajaxSubmit({
						url : "${path }/xx/app/console/gbmc/save",
						type : "post",
						dataType : "json",
		...
		<%--if(bool){--%>
			<%--$.cloudAjax({--%>
				...
				<%--success : function(data){--%>
					<%--if(data.success){--%>
						<%--showTip("提示","操作成功",2000);--%>
						<%--setTimeout(function(){window.location.href = "${path}/xx/app/console/gbmc/"},2000);--%>
					<%--}else{--%>
