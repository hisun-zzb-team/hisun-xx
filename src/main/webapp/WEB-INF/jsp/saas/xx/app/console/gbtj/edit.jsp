					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-body form">
								...
								<form action="${path }/xx/app/console/gbtj/save?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" class="form-horizontal" id="form1" method="post">
									...
									<div class="form-actions">
										...
										<a class="btn" href="${path }/xx/app/console/gbtj/?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}"><i class="icon-remove-sign"></i> 取消</a>
...
<script type="text/javascript">
	...
	function formUpdate(){
		...
		if(bool){
			$.cloudAjax({
				path : '${path}',
				url : "${path }/xx/app/console/gbtj/save",
				type : "post",
